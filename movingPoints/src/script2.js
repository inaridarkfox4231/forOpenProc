...
class graphData{
  ...
  loadGraph(){
    let edgeData = [[40, 40], [160, 40], [160, 160], [40, 160]];
    let inData = [[3, 7], [0, 6], [1, 5], [2, 4]];
    let outData = [[0, 4], [1, 7], [2, 6], [3, 5]];
    ...
    let itvData = [[0, 1, 120], [1, 2, 120], [2, 3, 120], [3, 0, 120], [0, 3, 120], [3, 2, 120], [2, 1, 120], [1, 0, 120]];
  ...
  makeGraphic(){
    let lineData = [[0, 1], [1, 2], [2, 3], [3, 0]]; // この場合は最大で6本引ける
